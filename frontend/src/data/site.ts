...
export const siteDescription =
  "Building the world's first billion-dollar company with one human. Everything I do is built on Bittensor, with a focus on agentic-powered backends and distributed infrastructure.";
