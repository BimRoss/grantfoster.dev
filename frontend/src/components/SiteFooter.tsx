  ...
  return (
    ...
    >
      <nav
        ...
        className="mb-1.5 flex items-center justify-center gap-4 text-[10px] text-zinc-700 md:text-xs"
      >
        <Link href="/" className="underline-offset-2 hover:underline focus-visible:underline">
          Home
        </Link>
        <Link
          href="/about"
